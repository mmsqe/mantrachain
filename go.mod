...
replace (
	cosmossdk.io/api => github.com/mmsqe/cosmos-sdk/api v0.2.7-0.20251205093647-ef577ab5e9de
	...
	github.com/cosmos/cosmos-sdk => github.com/mmsqe/cosmos-sdk v0.46.0-beta2.0.20251205093647-ef577ab5e9de
)
