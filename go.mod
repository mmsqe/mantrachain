...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/mmsqe/cosmos-sdk v0.46.0-beta2.0.20251117062908-7c39e6ef32a0

	// release/v0.5.x
	github.com/cosmos/evm => github.com/mmsqe/evm v0.0.0-20251117063428-f4caf9edd9ee
