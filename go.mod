...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/mmsqe/cosmos-sdk v0.46.0-beta2.0.20251118030153-ab1fd2747cae

	// release/v0.5.x
	github.com/cosmos/evm => github.com/mmsqe/evm v0.0.0-20251118030226-ed0dde9a628d
